...
public class Example {
    public static void main(String[] args) throws Exception {
        ...
        AbstractMqttsnRuntimeRegistry registry = 
        ...
        try (MqttsnClient client = new MqttsnClient()) {
            ...
            client.registerListener((String topic, int qos, byte[] data) -> {
                System.err.println(String.format("I got my own message [%s]",
                        new String(data, MqttsnConstants.CHARSET)));
                latch.countDown();
            });
            client.connect(60, true);
            client.subscribe("my/example/topic/1", 2);
            client.publish("my/example/topic/1", 0, "hello-QoS0".getBytes(), true);
